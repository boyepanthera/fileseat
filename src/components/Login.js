...
import { LeftNavbar, RightLoginNavbar, ResetNavbar } from "./Navbar";
...
const Login = () => {
  ...
  const handleLogin = values => {
    ...
    axios
      ...
      .post("https://server.fileseat.com/api/v1/users/login", values, {
        headers: {
  ...
  return (
    <HelmetProvider>
      <div className="h-screen flex flex-wrap">
        ...
        <div className="md:w-1/2 w-full m-0   bg-gray-300">
          <div className='w-full p-10 sm:px-20 sm:py-10'>
